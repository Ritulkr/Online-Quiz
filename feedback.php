...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">kumarritul089@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/avatar.jpg" width=100 height=100 alt="Ritul Kumar" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Ritul Kumar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91-7004562617</h4>
		<h4 style="font-family:'typo' ">kumarritul089@gmail.com</h4>
		<h4 style="font-family:'typo' ">Birla Institute of Technology - Mesra</h4></div></div>
		</p>
      </div>
